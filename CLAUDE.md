...
- This normalization change advances the opaque Codex snapshot cursor version to `2`; older cursors fall back to a complete snapshot so retained prefixes normalized under the duplicate behavior are repaired rather than reused.
