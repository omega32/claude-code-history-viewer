...
- User-authorship provenance advances the opaque Codex snapshot cursor version to `3`; older cursors fall back to a complete snapshot so retained prefixes without the new subtype contract are repaired rather than reused.
